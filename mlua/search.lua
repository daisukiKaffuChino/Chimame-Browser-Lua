...
function onCreate()
  ...
  dmlist.setOnItemClickListener(AdapterView.OnItemClickListener{
    onItemClick=function(id,v,zero,one)
      ...
      activity.newActivity("mlua/view-code",{v.Tag._title.Text,v.Tag._text.Text})
    end})
  ...
  jclist.setOnItemClickListener(AdapterView.OnItemClickListener{
    onItemClick=function(id,v,zero,one)
      activity.newActivity("mlua/view-tutorial",{v.Tag._title.Text,one,jcdata})
    end})
  ...
  spjc.setOnItemClickListener(AdapterView.OnItemClickListener{
    onItemClick=function(id,v,zero,one)
      activity.newActivity("mlua/video-play",{v.Tag._text.Text})
    end})
